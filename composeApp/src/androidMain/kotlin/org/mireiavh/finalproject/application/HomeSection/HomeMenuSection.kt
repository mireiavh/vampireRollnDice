...
import org.mireiavh.finalproject.utils.ManualListContent
import org.mireiavh.finalproject.utils.SearchAndFilterSection

@Composable
fun HomeMenuSection(viewModel: ManualViewModel) {
    ...
    when {
        ...
        uiState.errorMessage != null -> {
            ...
            Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
                ...
                ManualListContent(manuals = filteredManuals, searchQuery = searchQuery)
            }
        }
    }
}